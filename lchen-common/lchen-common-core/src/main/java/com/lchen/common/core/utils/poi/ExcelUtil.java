package com.lchen.common.core.utils.poi;

import com.lchen.common.core.annotation.Excel;
import com.lchen.common.core.annotation.Excel.*;
import com.lchen.common.core.annotation.Excels;
import com.lchen.common.core.text.Convert;
import com.lchen.common.core.utils.DateUtils;
import com.lchen.common.core.utils.StringUtil;
import com.lchen.common.core.utils.file.FileTypeUtils;
import com.lchen.common.core.utils.file.ImageUtils;
import com.lchen.common.core.utils.reflect.ReflectUtils;
...
public class ExcelUtil<T>
{
        ...
        if (rows > 0)
        {
            ...
            for (int i = 1; i < rows; i++)
            {
                ...
                for (Map.Entry<Integer, Field> entry : fieldsMap.entrySet())
                {
                    ...
                    else if ((Integer.TYPE == fieldType || Integer.class == fieldType) && StringUtil.isNumeric(Convert.toStr(val)))
                    {
    ...
    public void setCellVo(Object value, Excel attr, Cell cell)
    {
        ...
        {
            cell.setCellValue(StringUtil.contains(Convert.toStr(value), ".") ? Convert.toDouble(value) : Convert.toInt(value));
        }
