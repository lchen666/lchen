...
public class CodeGeneratorUtil {
    ...
    public static void main(String[] args) {
        ...
        dsc.setUrl("jdbc:mysql://127.0.0.1:3306/lchen?characterEncoding=utf8&characterSetResults=utf8&useUnicode=false&rewriteBatchedStatements=true&autoReconnect=true&allowMultiQueries=true&serverTimezone=GMT%2b8");
