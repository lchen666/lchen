...
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES (100, NULL, 'lchen', '廖晨', '00', '', '', '0', '', '91ZB5c/GhZlPJwd+kXY3jA==', '0', '0', '', NULL, '', NULL, '', NULL, NULL);
...
CREATE TABLE `user`  (
  ...
  `del_flag` int(4) NOT NULL DEFAULT 0 COMMENT '是否删除',
  PRIMARY KEY (`user_id`) USING BTREE
...
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES (1, '150****2906', '15070092906', NULL, NULL, 0);
